    ...
    880: (t, r, e) => {
      ...
      function a() {
        ...
        function f(t, r, e, o) {
          var i = r && r.prototype instanceof v ? r : v,
            ...
            c = new O(o || []);
          return n(a, "_invoke", { value: _(t, e, c) }), a;
        }
        function h(t, r, e) {
          try {
      ...
      const s = {
            ...
            a().mark(function r() {
              ...
              return a().wrap(function (r) {
                for (;;)
                  switch ((r.prev = r.next)) {
                    case 0:
                      return (r.next = 2), n.Z.getRestaurant(t);
                    case 2:
        ...
        _renderLike: function () {
          var t = this;
          (this._likeButtonContainer.innerHTML = (0, o.ty)()),
                ...
                a().mark(function r() {
                  return a().wrap(function (r) {
                    for (;;)
                      switch ((r.prev = r.next)) {
                        case 0:
                          return (r.next = 2), n.Z.putRestaurant(t._restaurant);
                        case 2:
                          t._renderButton();
                        case 3:
                        case "end":
        ...
        _renderLiked: function () {
          var t = this;
          (this._likeButtonContainer.innerHTML = (0, o.ci)()),
            document.querySelector("#likeButton").addEventListener(
              "click",
              u(
                a().mark(function r() {
                  return a().wrap(function (r) {
                    for (;;)
                      switch ((r.prev = r.next)) {
                        case 0:
                          return (
                            (r.next = 2), n.Z.deleteRestaurant(t._restaurant.id)
                          );
                        case 2:
                          t._renderButton();
                        case 3:

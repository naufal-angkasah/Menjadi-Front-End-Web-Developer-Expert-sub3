(() => {
    ...
    A = {
      ...
      15: (n, A, r) => {
        var e = r(379),
          ...
          g = r(389),
          c = {};
        (c.styleTagTransform = E()),
          (c.setAttributes = p()),
          (c.insert = d().bind(null, "head")),
          (c.domAPI = o()),
          (c.insertStyleElement = B()),
          t()(g.Z, c),
  ...
  function e(n) {
    ...
    return A[n](i, i.exports, e), i.exports;
  }
  (e.m = A),
    (n = []),
    (e.O = (A, r, t, i) => {
      if (!r) {
        ...
        for (p = 0; p < n.length; p++) {
          for (var [r, t, i] = n[p], a = !0, d = 0; d < r.length; d++)
            (!1 & i || o >= i) && Object.keys(e.O).every((n) => e.O[n](r[d]))
              ? r.splice(d--, 1)
              : ((a = !1), i < o && (o = i));
          if (a) {
            n.splice(p--, 1);
    ...
    (() => {
      ...
      var A = (A, r) => {
          ...
          for (A && A(r); l < o.length; l++)
            (i = o[l]), e.o(n, i) && n[i] && n[i][0](), (n[i] = 0);
          return e.O(p);
        },
        r = (self.webpackChunkrestaurant_apps =
          self.webpackChunkrestaurant_apps || []);
      r.forEach(A.bind(null, 0)), (r.push = A.bind(null, r.push.bind(r)));
    })(),
    (e.nc = void 0);
  var t = e.O(void 0, [946, 2, 495, 337, 268], () => e(253));
  t = e.O(t);
})();
